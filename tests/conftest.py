...
RUN_KNOBS = ("L", "CHUNK", "HEAD_BLOCK", "STEPS", "MODE", "UNIFORM_L", "SKIP_DENSE_E9", "EXTENDED_E9",
             ...
             "NEED_RULER", "DATA_RULER", "DATA_MUSIQUE", "HOTPOT_N", "EVAL", "PREFLIGHT_FORCE_DETECTOR", "EVAL_HEAD_BLOCK", "PHASE_A_ONLY", "JOBS_PER_GPU", "MULTI_POD", "POD_ID", "LAUNCHER", "SHARD", "FAIL_MATCH", "INIT_GAP_POLICY", "ONLY", "GPUS", "MARSEA_TOL_CAP")
